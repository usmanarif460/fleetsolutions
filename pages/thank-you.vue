<template>
  <main class="bg-gradient-to-r from-indigo-100 to-violet-400">
    <section
      class="max-w-7xl mx-auto flex flex-col items-center p-20 justify-center"
    >
      <div class="flex flex-col items-center justify-center">
        ...
        <div class="py-20 pointer-events-none inset-x-0 bottom-0 px-6 w-full">
          <div
            class="rounded-xl bg-black p-6 shadow-lg ring-1 ring-gray-900/10"
          >
            <p class="text-huge leading-6 text-white">
              Invite And Get
              <strong class="underline underline-offset-2 text-purple"
                >$50</strong
              >
            </p>
            <div>
      ...
      <div class="py-10 border-b-2">
        <div class="grid grid-cols-3 gap-5">
          <div>
            ...
            <p class="mt-5">
              Share your link with friends on email, social media, or chat.
              You’ll be giving them a slight statistical edge.
            </p>
          </div>
          <div>
            <div class="relative w-1/4 mx-auto rounded-full shadow-lg p-6">
            ...
            <p class="mt-5">
              We’ll give several extra points in our review process to those who
              come in through your custom link.
            </p>
          </div>
          <div>
            <div class="relative w-1/4 mx-auto rounded-full shadow-lg p-6">
            ...
            <p class="mt-5">
              You’ll earn <span class="text-purple">$50</span> for every person
              you invite whose website we build.
            </p>
          </div>
        </div>
      </div>
      <div class="py-10">
        <div>
          <p>
            *While we don’t earn money in offering free websites, a percentage
            of our clients come back to us for paid projects further down the
            line (which is why we offer an affiliate program). See more about
